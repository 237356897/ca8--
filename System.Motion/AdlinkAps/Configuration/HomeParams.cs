namespace Motion.AdlinkAps
{
    ...
    public class HomeParams
    {
        ...
        /// 回原点参数
        /// </summary>
        /// <param name="mode">回零模式 0：ORG,1：EL,2：EZ</param>
        /// <param name="dir">回零方向 0：Positive, 1:Negative</param>
        /// <param name="ez">寻找Z向信号 0：NO，1：YES</param>
        /// <param name="maxVel">回零最大速度</param>
        /// <param name="orgVel">找原点速度</param>
        /// <param name="shift">回零偏移</param>
