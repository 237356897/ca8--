...
{
    public class DM50S : SerialPort, ISerialPortTriggerModel
    {
        /*
        ...
        public DM50S(string portName, int baudRate, Parity parity, int dataBits, StopBits stopBits) : base(portName, baudRate, parity, dataBits, stopBits) { }
