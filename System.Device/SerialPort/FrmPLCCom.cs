...
{
    public partial class FrmPLCCom : Form
    {
        #region 变量
        ...
        public FrmPLCCom(PLCCom idevice, Type type)
            : this()
        {
            _device = (PLCCom)type.Assembly.CreateInstance(type.FullName);
            _device = idevice;
        ...
        void Form_SerialPort_Load(object sender, EventArgs e)
        {
            ...
            button_Connect.Enabled = _device.sp.IsOpen ? false : true;
            button_Close.Enabled = _device.sp.IsOpen ? true : false;
        }
