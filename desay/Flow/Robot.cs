...
namespace Desay
{
    ...
    public class Robot : StationPart
    {
                    ...
                    if (stationOperate.Running && Marking.AlarmStopThread)
                    {
                        ...
                        switch (Step)
                        {
                            ...
                            case 50:
                                ...
                                else if (Marking.DownStoveRefreshState[3] && (Marking.RobotStatus == Output.s20) && !RunPara.Instance.Stove4Shield)
                                {
                                    if (!Marking.RobotInformOutputting)
                                    {
                                        Marking.RobotInformOutputting = true;
                            ...
                            case 130:
                                ...
                                {
                                    frmPlc.WriteM(frmPlc.Stove1DoorTrip, true); //炉1关门
                            ...
                            case 230:
                                ...
                                {
                                    frmPlc.WriteM(frmPlc.Stove2DoorTrip, true); //炉2关门
                                    //Thread.Sleep(4000);
                                    Step = 240;
                                }
                                break;
                            ...
                            case 320:
                                ...
                                //else
                                //{
                                //    frmPlc.WriteM(frmPlc.Stove3DoorTrip, true);
                                //    Thread.Sleep(4000);
                                //}
                                break;
                            case 330:
                                ...
                                {
                                    frmPlc.WriteM(frmPlc.Stove3DoorTrip, true); //炉3关门
                                    //Thread.Sleep(4000);
                                    Step = 340;
                                }
                                break;
                            ...
                            case 420:
                                ...
                                {
                                    mAsynTcpRobot.AsynSend("4boxpk"); //炉1取盘
                                    Step = 430;
                                }
                                break;
                            case 430:
                            ...
                            case 700:
                                if (RunPara.Instance.OKTary.ProductPos == RunPara.Instance.TrayPoint || Marking.ImmediatelyUpStove)  //OK满盘上炉 或 立即上炉
                                {
                                    ...
                                    {
                                        if (Marking.UpStoveRefreshState[0] && !RunPara.Instance.Stove1Shield)
                                        {
                                            Step = 900;
                                        }
                                        ...
                                        else if (Marking.UpStoveRefreshState[3] && !RunPara.Instance.Stove4Shield)
                                        {
                                            Step = 1200;
                                        }
                            ...
                            case 710:
                                if (/*IoPoints.T1DI08.Value*/Marking.AAOK || RunPara.Instance.ShieldAAOK) //产品OK
                                {
                                    ...
                                    else if (IoPoints.I2DI18.Value) //待料位1有盘
                                    {
                                        Thread.Sleep(1000);
                                        mAsynTcpRobot.AsynSend("3plapk"); //通知机械手——从待料位1取盘至OK位
                                        Step = 720;
                                    }
                                    else if (IoPoints.I2DI21.Value) //待料位2有盘
                                    {
                                        Thread.Sleep(1000);
                                        mAsynTcpRobot.AsynSend("4plapk"); //通知机械手——从待料位2取盘至OK位
                                        Step = 730;
                                    }
                                    ...
                                    else if (WishoutDiskTime.ElapsedMilliseconds > RunPara.Instance.WishoutDiskWaitTime)  //等待来盘超时报警
                                    {
                                ...
                                else if (/*IoPoints.T1DI09.Value*/Marking.AANG || RunPara.Instance.ShieldAANG) // 产品NG
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        Marking.AlarmStopThread = false;
                                        //MessageBox.Show("NG料盘已man_清料,请按暂停再启动");
                                        Step = 0;  //1130
                                    }
                                }
                                else
                            ...
                            case 780://扫产品码
                                //if (ifemptyrun)
                                //{
                                // QRCodeReader.receiveFinish = true;
                                // RunPara.Instance.OKTary.QRCode[RunPara.Instance.OKTary.ProductPos].SN = "SB01SB02SB03";
                            ...
                            case 1310:
                                ...
                                if (tcpResults.Length > 0 && tcpResults[0].Contains("1plapk"))
                                {
                                    mAsynTcpRobot.AsynSend("5boxpw");//机器人移至炉2上方
                                    Step = 1320;
                                }
                                break;
                            case 1320:
        ...
        public bool ScanSN(string strSN)
        {
            ...
            try
            {
                SN = $"{RunPara.Instance.A2C}{0}{strSN.Substring(strSN.Length - 6)}";
                result = Common.Test_ScanSN(RunPara.Instance.IsUseMesLock, SN);
            }
            catch
            {
                result = false;
